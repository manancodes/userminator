...
const Home = () => {
  ...
  const socialMediaPlatforms = [
    ...
    },
    {
      name: "Instagram",
      available: false,
      image: "instagram-placeholder.jpg",
      svg: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-7 w-7"
    ...
    },
    {
      name: "Facebook",
      available: true,
      image: "facebook-placeholder.jpg",
      svg: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-7 w-7"
        ...
        <div className="flex items-center justify-center">
          <div className="flex items-center justify-between space-x-2 bg-neutral-900 border border-neutral-600 text-white rounded-full p-2 w-96">
            <input
              ...
              className="pl-6 bg-neutral-900 text-white placeholder-neutral-500 p-2 focus:outline-none"
              onChange={(e) => {
